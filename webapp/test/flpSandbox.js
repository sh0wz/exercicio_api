		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Exercicio para consumo de API",
									"targetURL": "#vdlcombrexercicioapi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vdlcombrexercicioapi-display": {
								"semanticObject": "vdlcombrexercicioapi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vdl.com.br.exercicioapi",
									"url": sap.ui.require.toUrl("vdl/com/br/exercicioapi")
								}
							}
						}
					}
